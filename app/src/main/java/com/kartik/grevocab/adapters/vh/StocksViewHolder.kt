...
class StocksViewHolder(val binding: InflateStocksBinding, private val clickListener: OnBindClickListener) : BaseBindingViewHolder(binding), View.OnClickListener {
